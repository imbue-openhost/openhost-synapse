...
<p id="msg">Signing you in to Cloud in a Bottle Community Chat...</p>
<script>
(function () {
...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Set up Cloud in a Bottle Community Chat</title>
<style>
  *,*::before,*::after{box-sizing:border-box}
...
<body><div class="container">
  <h1>Set up Cloud in a Bottle Community Chat</h1>
...
<html lang="en"><head><meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Cloud in a Bottle Community Chat: help</title>
<style>
  *,*::before,*::after{box-sizing:border-box}
  body{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;background:#0f1117;color:#e2e8f0;margin:0;padding:2rem;min-height:100vh}
...
<body><div class="container">
  <h1>Cloud in a Bottle Community Chat</h1>
